                    ...
                    <Form {...form}>
                        ...
                        >
                            <div className="flex flex-col gap-6">
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input
                                                        type="email"
                                                        placeholder="meet-b4@example.com"
                                                        {...field}
                                                    />
                                                </FormControl>
                                                <FormMessage />
                                ...
                                <div
                                    className="afer:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t"
                                >
